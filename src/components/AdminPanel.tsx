...
export const AdminPanel: React.FC = () => {
  const { products, contactSettings, inquiries, addProduct, updateProduct, deleteProduct, updateContactSettings } = useApp();
              ...
              <div className="bg-gray-900 rounded-xl p-4 sm:p-6 border border-gray-800">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-6">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-medium rounded-lg transition-colors"
                  >
          ...
          <div className="bg-gray-900 rounded-xl p-4 sm:p-6 border border-gray-800">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-medium rounded-lg transition-colors"
              >
